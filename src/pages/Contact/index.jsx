...
function Contact() {
    ...
    return ( 
        <div className="mt-20">
            ...
            <div className='w-full bg-bg-primary text-center pt-60 md:pt-32 lg:pt-100 flex justify-center px-4 md:px-0'>
                <form onSubmit={handleSubmit} className='flex flex-col xl:max-w-[440px] justify-start w-full text-[16px] md:text-[18px]'>
